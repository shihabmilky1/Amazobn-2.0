...
function Product({ id, title, price, category, description, image }) {
    ...
    const addItemToBasket = () => {
        ...
        // send product using redux
        dispatch(addToBasket(products), toast.success('Add To Basket'))

    }


    return (
        <Zoom duration={2500} distance="40px">
            <div className="relative flex flex-col m-5 bg-white z-30 p-10">
                ...
                {hasPrime && (
                    <div className="flex items-center space-x-2-mt-5">
                        <img className="w-10" src="https://links.papareact.com/fdw" />
